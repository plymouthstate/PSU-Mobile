...
class Rss extends Feeds {
	...
	/*
	 * Method to set the total limit of posts
	 * @param int $limit An integer amount of total posts to return
	 */
	public function set_total_limit($limit) {
		return $this->limit_posts_total = $limit;
	}
