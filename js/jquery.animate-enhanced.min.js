...
@benpbarnett
*/
(function(d,z,A){function E(a,b,j,c){var f=F.exec(b),e="auto"===a.css(j)?0:a.css(j),e="string"==typeof e?w(e):e;"string"==typeof b&&w(b);var c=!0===c?0:e,d=a.is(":hidden"),h=a.translation();"left"==j&&(c=parseInt(e,10)+h.x);"right"==j&&(c=parseInt(e,10)+h.x);"top"==j&&(c=parseInt(e,10)+h.y);"bottom"==j&&(c=parseInt(e,10)+h.y);!f&&"show"==b?(c=1,d&&a.css({display:"block",opacity:0})):!f&&"hide"==b&&(c=0);return f?(a=parseFloat(f[2]),f[1]&&(a=("-="===f[1]?-1:1)*a+parseInt(c,10)),a):c}function G(a,b,
j,c,f,e,g,h){var i=a.data(q),i=i&&!u(i)?i:d.extend(!0,{},H),n=f;if(-1<d.inArray(b,x)){var o=i.meta,m=w(a.css(b))||0,l=b+"_o",n=f-m;o[b]=n;o[l]="auto"==a.css(b)?0+n:m+n||0;i.meta=o;g&&0===n&&(n=0-o[l],o[b]=n,o[l]=0)}return a.data(q,I(a,i,b,j,c,n,e,g,h))}function I(a,b,d,c,f,e,g,h,i){var n=!1,g=!0===g&&!0===h,b=b||{};if(!b.original)b.original={},n=!0;b.properties=b.properties||{};b.secondary=b.secondary||{};for(var h=b.meta,o=b.original,m=b.properties,q=b.secondary,p=l.length-1;0<=p;p--){var k=l[p]+
"transition-property",r=l[p]+"transition-duration",s=l[p]+"transition-timing-function",d=g?l[p]+"transform":d;n&&(o[k]=a.css(k)||"",o[r]=a.css(r)||"",o[s]=a.css(s)||"");q[d]=g?(!0===i||!0===y&&!1!==i)&&B?"translate3d("+h.left+"px, "+h.top+"px, 0)":"translate("+h.left+"px,"+h.top+"px)":e;m[k]=(m[k]?m[k]+",":"")+d;m[r]=(m[r]?m[r]+",":"")+c+"ms";m[s]=(m[s]?m[s]+",":"")+f}return b}function J(a){for(var b in a)if(("width"==b||"height"==b)&&("show"==a[b]||"hide"==a[b]||"toggle"==a[b]))return!0;return!1}
...
easeInOutCubic:"cubic-bezier(0.645, 0.045, 0.355, 1.000)",easeInOutQuart:"cubic-bezier(0.770, 0.000, 0.175, 1.000)",easeInOutQuint:"cubic-bezier(0.860, 0.000, 0.070, 1.000)",easeInOutSine:"cubic-bezier(0.445, 0.050, 0.550, 0.950)",easeInOutExpo:"cubic-bezier(1.000, 0.000, 0.000, 1.000)",easeInOutCirc:"cubic-bezier(0.785, 0.135, 0.150, 0.860)",easeInOutBack:"cubic-bezier(0.680, -0.550, 0.265, 1.550)"},p={},j=j[c.easing||"swing"]?j[c.easing||"swing"]:c.easing||"swing",k;for(k in a)if(-1===d.inArray(k,
...
return!0})};d.fn.animate.defaults={};d.fn.stop=function(a,b,j){if(!D)return A.apply(this,[a,b]);a&&this.queue([]);this.each(function(){var c=d(this),f=c.data(q);if(f&&!u(f)){var e,g={};if(b){if(g=f.secondary,!j&&void 0!==typeof f.meta.left_o||void 0!==typeof f.meta.top_o){g.left=void 0!==typeof f.meta.left_o?f.meta.left_o:"auto";g.top=void 0!==typeof f.meta.top_o?f.meta.top_o:"auto";for(e=l.length-1;0<=e;e--)g[l[e]+"transform"]=""}}else if(!u(f.secondary)){var h=window.getComputedStyle(c[0],null);
if(h)for(var i in f.secondary)if(f.secondary.hasOwnProperty(i)&&(i=i.replace(N,"-$1").toLowerCase(),g[i]=h.getPropertyValue(i),!j&&/matrix/i.test(g[i]))){e=g[i].replace(/^matrix\(/i,"").split(/, |\)$/g);g.left=parseFloat(e[4])+parseFloat(c.css("left"))+"px"||"auto";g.top=parseFloat(e[5])+parseFloat(c.css("top"))+"px"||"auto";for(e=l.length-1;0<=e;e--)g[l[e]+"transform"]=""}}c.unbind(v).css(f.original).css(g).data(q,null)}else A.apply(c,[a,b])});return this}})(jQuery,jQuery.fn.animate,jQuery.fn.stop);
